                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('web.blog.artigo', $post->slug) }}" target="_blank" class="rounded-lg p-2 text-gray-400 hover:bg-gray-100 hover:text-blue-600 transition" title="Ver no site">
