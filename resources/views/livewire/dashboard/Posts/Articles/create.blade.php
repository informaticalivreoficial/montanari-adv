<div>
    ...
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Crie um novo artigo para o blog.</p>
        </div>
    </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="rounded-xl border border-gray-200 bg-white shadow-sm">
                    <div class="px-6 py-5">
                        ...
                        <div class="space-y-4">
                            <x-input name="metaDescription" label="Meta Descrição" placeholder="Descrição para mecanismos de busca (máx. 160 caracteres)" wire:model="metaDescription" />
                ...
                <div class="rounded-xl border border-gray-200 bg-white shadow-sm">
                    <div class="px-6 py-5">
                        <x-image-gallery wireModel="images" label="Imagens do Artigo" :showUpload="true" />
                    </div>
                </div>
            </div>
