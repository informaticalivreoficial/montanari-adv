<div>
    ...
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Atualize os dados da tarefa.</p>
        </div>
    </div>
            ...
            <div class="space-y-6">
                <div class="rounded-xl border border-gray-200 bg-white shadow-sm">
                    <div class="px-6 py-5">
                        ...
                        <select wire:model="process_id" class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm text-gray-900 shadow-sm focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 focus:outline-none transition">
