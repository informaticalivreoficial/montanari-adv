                ...
                <div class="rounded-xl border border-gray-200 bg-white shadow-sm">
                    ...
                    <div class="px-6 py-5">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <x-input name="process_number" label="Número do Processo" required wire:model="process_number" />
                            <x-input name="court_name" label="Nome do Tribunal" wire:model="court_name" />
                            <x-input name="court_variable" label="Vara" wire:model="court_variable" />
                            <div class="space-y-1">
                            ...
                            <x-input name="case_area" label="Área" wire:model="case_area" />
                        </div>
                    </div>
                    ...
                    <div class="px-6 py-5">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <x-input name="opposing_party" label="Parte Contrária" wire:model="opposing_party" />
                            <x-input name="opposing_lawyer" label="Advogado da Parte Contrária" wire:model="opposing_lawyer" />
                        </div>
                    </div>
                    ...
                    <div class="px-6 py-5">
                        ...
                        <x-textarea name="description" label="Descrição do Processo" rows="3" wire:model="description" />
                    </div>
                    ...
                    <div class="px-6 py-5">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <x-input name="contract_value" label="Valor do Contrato" wire:model="contract_value" />
                    ...
                    <div class="px-6 py-5">
                        ...
                        <x-textarea name="internal_notes" rows="3" wire:model="internal_notes" />
                    </div>
                </div>
            </div>
