<div>
    ...
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Atualize as informações de <span class="font-medium text-gray-700">{{ $user->name }}</span></p>
        </div>
    </div>
                ...
                <div class="rounded-xl border border-gray-200 bg-white shadow-sm">
                    ...
                    <div class="px-6 py-5">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <x-input name="name" label="Nome completo" required wire:model="name" />
                            <x-input name="email" label="E-mail" type="email" required wire:model="email" />
                        </div>
                    </div>
                        ...
                        <div class="flex items-center gap-6">
                            <div class="shrink-0">
                                ...
                                @elseif($currentAvatar)
                                    <img src="{{ $currentAvatar }}" alt="{{ $name }}" class="h-16 w-16 rounded-full object-cover border-2 border-amber-200">
                                @else
                            ...
                            <div class="flex-1">
                                ...
                                >
                                <p class="mt-1 text-xs text-gray-500">JPG, PNG ou GIF. Máximo 2MB. Deixe vazio para manter a foto atual.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="px-6 py-5">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between text-sm">
                                ...
                                <span class="text-gray-900">{{ $user->last_login_at?->format('d/m/Y H:i') ?? 'Nunca' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
