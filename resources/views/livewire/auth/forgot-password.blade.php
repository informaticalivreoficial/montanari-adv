<div>
    ...
    <p class="mt-1 text-sm text-slate-500">Informe seu e-mail e enviaremos um link para redefinir sua senha.</p>
    ...
    <form wire:submit.prevent="sendResetLink" novalidate class="mt-6 space-y-5">
