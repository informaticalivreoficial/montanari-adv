        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('admin.categorias.secao', ['tipo' => $tipo])}}">Categorias</a></li>
                    @elseif($tipo == 'noticia')
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12">   
                                ...
                                <textarea id="compose-textarea" name="content" cols="30" rows="10" placeholder="Escreva a descrição da categoria aqui">{{ old('content') }}</textarea>                                                      
                            </div>
                        </div>  
                        </form>
                    </div>                
