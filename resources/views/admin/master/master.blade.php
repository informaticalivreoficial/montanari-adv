...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="copyright" content="{{($configuracoes ?? (object)[])->ano_de_inicio}} {{$($configuracoes ?? (object)[])->nomedosite}}">
        <meta name="description" content="{{$($configuracoes ?? (object)[])->descricao}}" />    
        <meta name="url" content="{{$($configuracoes ?? (object)[])->dominio}}" />
        <meta name="title" content="{{$($configuracoes ?? (object)[])->nomedosite}}" />
        <meta name="keywords" content="{{$($configuracoes ?? (object)[])->metatags}}" />
        ...
        <!-- :: Favicon -->
        <link rel="shortcut icon" href="{{$($configuracoes ?? (object)[])->getfaveicon()}}"/>
        <link rel="apple-touch-icon" href="{{$($configuracoes ?? (object)[])->getfaveicon()}}"/>
        <link rel="apple-touch-icon" sizes="72x72" href="{{$($configuracoes ?? (object)[])->getfaveicon()}}"/>
        <link rel="apple-touch-icon" sizes="114x114" href="{{$($configuracoes ?? (object)[])->getfaveicon()}}"/>
    ...
    <body>
                    ...
                    <div class="box-content d-flex align-items-center justify-content-between">
                        <div class="logo">
                            <a href="{{route('web.home')}}" class="logo-nav">
                                ...
                                <img class="img-fluid two" src="{{$($configuracoes ?? (object)[])->getlogomarca()}}" alt="{{$($configuracoes ?? (object)[])->nomedosite}}">
                            </a>
        ...
        <div class="menu-box">
            <div class="inner-menu">
                <div class="website-info">
                    <a href="{{route('web.home')}}" class="logo"><img class="img-fluid" src="{{$($configuracoes ?? (object)[])->getlogomarca()}}" alt="{{$($configuracoes ?? (object)[])->nomedosite}}"></a>                    
                </div>
        ...
        <footer class="footer">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-5">
                        <div class="logo">
                            <img class="img-fluid" src="{{url('frontend/assets/images/logo/01_logo.png')}}" alt="{{$($configuracoes ?? (object)[])->nomedosite}}">
                            <p>{{$($configuracoes ?? (object)[])->descricao}}</p>
                            <ul>
                                @if(!empty($configuracoes?->facebook))
                                    <li><a target="_blank" href="{{$configuracoes->facebook}}" title="Facebook"><i class="fab fa-facebook-f"></i></a></li>
                                @endif
            ...
            <div class="copyright" style="padding-bottom: 0;">
                <div class="container">
                    <p>© {{$($configuracoes ?? (object)[])->ano_de_inicio}} {{$($configuracoes ?? (object)[])->nomedosite}} - Todos os direitos reservados</p>
                    <ul>
