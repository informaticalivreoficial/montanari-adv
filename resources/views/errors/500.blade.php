...
<head>
    ...
    <title>Erro Interno · Montanari Adv</title>
...
<body class="min-h-screen bg-gray-50 flex items-center justify-center px-4">
    <div class="max-w-md w-full text-center">
        ...
        {{-- Código --}}
        <h1 class="text-7xl font-black text-gray-900">500</h1>

        {{-- Título --}}
        <h2 class="mt-4 text-2xl font-bold text-gray-900">Erro Interno do Servidor</h2>
