...
<head>
    ...
    <title>Sessão Expirada · Montanari Adv</title>
...
<body class="min-h-screen bg-gray-50 flex items-center justify-center px-4">
    <div class="max-w-md w-full text-center">
        ...
        {{-- Ícone --}}
        <div class="mb-6 inline-flex h-20 w-20 items-center justify-center rounded-full bg-yellow-100">
            <i class="fa-solid fa-clock-rotate-left text-4xl text-yellow-500"></i>
        </div>

        {{-- Código --}}
        <h1 class="text-7xl font-black text-gray-900">419</h1>

        {{-- Título --}}
        <h2 class="mt-4 text-2xl font-bold text-gray-900">Sessão Expirada</h2>

        {{-- Descrição --}}
        <p class="mt-3 text-gray-500">
            Sua sessão expirou por segurança.<br>
