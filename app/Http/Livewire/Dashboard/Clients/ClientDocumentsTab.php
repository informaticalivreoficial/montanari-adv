...
class ClientDocumentsTab extends Component
{
    ...
    public function saveDocument()
    {
        ...
        $userId = auth()->id();
        $path = "clients/{$this->clientId}/documents/" . date('Y') . '/' . date('m');
    ...
    {
        return view('livewire.dashboard.Clients.client-documents-tab');
    }
}
