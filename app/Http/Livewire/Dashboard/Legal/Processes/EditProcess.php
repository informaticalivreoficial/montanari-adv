...
class EditProcess extends Component
{
    ...
    public function update()
    {
        $this->validate([
            ...
            // detalhes
            'cnj_number' => 'nullable|string|max:30|unique:processes,cnj_number,' . $this->processId,
            'internal_code' => 'nullable|string|max:100|unique:processes,internal_code,' . $this->processId,
