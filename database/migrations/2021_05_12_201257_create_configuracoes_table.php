...
//            $table->string('desenvolvedor_url')->nullable();
//            $table->string('desenvolvedor_logo')->nullable();
//            $table->string('desenvolvedor_telefone')->nullable();
//            $table->string('desenvolvedor_email')->nullable();
